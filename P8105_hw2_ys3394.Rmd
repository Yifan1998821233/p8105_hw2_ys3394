...
```{r pols_df, warning = FALSE, message = FALSE}
rm(list = ls())
...
```{r snp_df, warning = FALSE, message = FALSE}
...
```{r unemployment_df, warning = FALSE, message = FALSE}
